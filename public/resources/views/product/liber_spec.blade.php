    ...
    <main class="top-nav-padding">
        ...
        <section>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane {{ !$HAVE_LIBER_U ? 'active' : '' }}" id="spec-1" role="tabpanel">
                    <div class="container">
                        <div class="logo-wrapper d-flex px-3 mt-4">
                            <div class="offset-md-1">
                                <img style="width: 200px;" src="{{ asset('images/win10_logo.png') }}" alt="Windows 10 Home">
                ...
                <div class="tab-pane {{ $HAVE_LIBER_U ? 'active' : '' }}" id="spec-5" role="tabpanel">
                    <div class="container">
                ...
                <div class="tab-pane" id="spec-4" role="tabpanel">
                    <div class="container">
